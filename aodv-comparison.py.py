...
path_found = False
final_path = []                    #global list to store the final path

class Node:
    def __init__(self, node_id):
        self.node_id = node_id     #Node id of node : Ex : A,B,C...
        self.sequence_num = 0      #Node's sequence number
        self.broadcast_id = 0      #Node's braodcast id
